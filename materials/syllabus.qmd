...
[Course Website](https://csu-arec-330.github.io/)

[Course Canvas](https://colostate.instructure.com/courses/162079)
...
Another option for accessing R is to use the DARE compute server I mentioned in class.  You can access RStudio on the server here: <http://darecompute-01.aggie.colostate.edu:8787/>. This link should simply work while you are **on campus**.  While you are **off campus**, you need to active the virtual private network (VPN).  You can find instructions for setting up the VPN here: <https://it.colostate.edu/cybersecurity/globalprotect-vpn/>.
