...
Office Hours: W 2-3PM & by appt </br>
In-Person: <https://app.usemotion.com/meet/lauren-chenarides/meeting> </br>
Via Teams: <https://app.usemotion.com/meet/lauren-chenarides/teams-meeting>
...
1.  Cheating -- Cheating includes using unauthorized sources of information and providing or receiving unauthorized assistance on any form of academic work or engaging in any behavior specifically prohibited by the instructor in the course syllabus or class presentation. **You may use generative AI tools (e.g., ChatGPT) as a coding assistant to help you solve problems and to help you understand the software used in this course. However, if you choose to use such tools, you are claiming the resulting work as your own, and you bear full responsibility for its accuracy and appropriateness. In your assignments, you must also disclose if AI tools were used and how. Doing so will not harm your grade; rather, it helps me guide you in using these tools effectively to enhance your grasp of the material. Remember, generative AI cannot advocate for itself or provide proper attributions; it is your responsibility to ensure integrity in your work.**
