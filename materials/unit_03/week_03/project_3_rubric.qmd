...
| Analysis (20 points)               | The model (regression or cluster) is identified and explained, assumptions and limitations are clearly discussed, and the results from the analysis are plotted and described in a clear and creative way. | The model is identified, assumptions and limitations are mentioned, and the results are plotted and described. | The model is not clearly identified, assumptions and limitations are not discussed, and/or the results are not plotted or described. |
