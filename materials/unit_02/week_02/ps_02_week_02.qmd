...
4. Write a narrative that interprets the `ggpairs()` plot. Describe the distribution of each variable and the correlations between variables, or other notable features you observe and explain their relevance to your analysis.
