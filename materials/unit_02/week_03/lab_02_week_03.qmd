---
title: "Week 11 Lab: Spatial data in R and visualizing results in Tableau"
format: 
  html:
    theme: zephyr
    toc: true
...
1. Connect to the dataset we used in R we created with results from our projections and current store numbesr (I named this `gs_all.csv`). You can either join this with the dataset used for the regression analysis on the geoid variable (to stay in the same workbook) or open a new workbook.
