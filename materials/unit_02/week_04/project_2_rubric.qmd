...
| Question (5 points)                | The question is realistic, clearly stated, and answerable with a cross sectional data analysis. | The question is somewhat realistic and answerable with a cross sectional data analysis. | The question is not realistic, clearly stated, or answerable with a cross sectional data analysis. |
...
| Analysis (15 points)               | The model is identified and explained, assumptions and limitations are clearly discussed, and the results from the analysis are plotted and described in a clear and creative way. | The model is identified, assumptions and limitations are mentioned, and the results are plotted and described. | The model is not clearly identified, assumptions and limitations are not discussed, and/or the results are not plotted or described. |
| Discussion/Conclusion (10 points) | The analysis is used to answer the question in a clear and creative way, and the key takeaways for the audience are clear and engaging. The next steps of a more in depth analysis are discussed. | The analysis is used to answer the question, and the key takeaways for the audience are clear. | The analysis is not used to answer the question, or the key takeaways for the audience are not clear. |
