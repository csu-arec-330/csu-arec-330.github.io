...
You should create a new webpage on your google site titled `Problem Set 1`. This webpage should include your responses to both Parts 1 and Parts 2 of the problem set. Part 1 should contain an R script with the code used to answer the questions. Generate a log file and submit that to Canvas.
