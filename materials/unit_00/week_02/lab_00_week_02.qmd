...
In problem set 2, you will flow this workflow to produce a simple data visualization using the grocery store spending dataset. 

## Analyzing data in Tableau

Next, we are going to go in more detail in the analyze step of the process. We will learn to make a few new figures, we will learn more of the features of the Tableau analysis page, and we will discuss a few ways to change the formatting of your visualizations to make them more effective.
