...
They use a regression model to study what factors explain variation in the suppression costs of past fires, then use that model to predict the suppression cost of a single fire. The predicted cost is compared to the actual cost. Fires that exceed their expected costs can be interogated more closely.
