---
title: "Week 3: Economic Theory of Decision Making"
format: 
  revealjs:
    theme: night
    slide-number: c/t
...
1.  Position this course in the AREC curriculum 

2.  Understand the importance of thinking through a problem to set up your analysis.

3.  Apply microeconomic theory to a real-world problem to generate testable hypotheses
...
What is microeconomic theory? (ECON/AREC 202)

&nbsp; 

How can we use microeconomic theory to guide our decision-making?


## An Example

![Source: <https://www.hazeldellmushrooms.com/farm/>](includes/hazeldell.jpeg)
