...
## [Download Lab Handout Here](lab_00_week_03_handout.pdf)
...
:::{.callout-important title="Difference Between `read.csv()` and `read_csv()`" collapse=true}
...
:::{.callout-note title="Tibbles vs. Data Frames" collapse=true}
...
:::{.callout-note title="Reading `mutate()` Syntax" collapse=true}
...
:::{.callout-note title="Reading `select()` Syntax" collapse=true}
...
:::{.callout-note title="Reading `rename()` Syntax" collapse=true}
...
:::{.callout-note title="Reading `filter()` Syntax" collapse=true}
...
:::{.callout-note title="Reading `arrange()` Syntax" collapse=true}
...
:::{.callout-important title="Reminder: Comment Your Code"}
...
:::{.callout-note title="Important points about `summarize()`" collapse=true}
...
:::{.callout-note title="Reading `group_by()` Syntax" collapse=true}
...
:::{.callout-note title="How to Read Piping Syntax" collapse=true}
...
:::{.callout-note title="Why Use Piping?" collapse=true}
...
The [`bind_rows()`](https://dplyr.tidyverse.org/reference/bind.html) function is used to **append (stack) multiple dataframes by rows**, even if they do not have identical column names. It is a flexible and efficient alternative to `rbind()` from base R.
...
:::{.callout-note title="Reading `bind_rows()` Syntax" collapse=true}
...
:::{.callout-important title="Difference Between `bind_rows()` and `rbind()`" collapse=true}
...
:::{.callout-tip title="Lab Script for Week 3: Data Processing with R" collapse="true"}
```{r}
#| eval: false
...
:::{.callout-important title="Important notes about running your log script"}
