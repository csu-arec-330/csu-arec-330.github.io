...
The `dplyr` function for appending rows is ^[[`bind_rows()`](https://dplyr.tidyverse.org/reference/bind.html) is a more efficient version of a function in base R called `rbind()`.]. This function efficiently combines multiple dataframes by stacking their rows together.
