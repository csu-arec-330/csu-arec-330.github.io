...
- **Question:** What packages do you need to have installed before loading in the data using this command? Write your response as a comment below the line of code where you load the necessary packages.
...
- **Explain:** What insights might this performance indicator provide to decision-makers in the company? Write your response as a comment below the line of code where you create the variable `rup`.
