...
Objective: forecast carrot prices in 5 years
:::
...
#| fig-width: 15
#| fig-align: center
#| fig-cap: "Trend calculated from STL decomposition using LOESS"
carrot_ts %>%
  model(stl=STL(price)) %>%
  components() %>%
  as_tsibble() %>%
...
#| fig-width: 10
#| fig-align: center
#| fig-cap: "Same ETS forecast based on data truncated at January 2021"
...
My guess: carrot prices subside then gradually increase because of declining trend in fertilizer 
