...
- In this example, a p-value of 0.02 means that there is a 2% chance of observing these data. We have strong evidence *against* the assumption that there is no relationship.
