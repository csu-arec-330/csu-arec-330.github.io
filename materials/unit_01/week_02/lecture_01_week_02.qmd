...
- Higher $R^2$ =  better fit; $R^2$ = 1 $\Rightarrow$ all variation is explained
...
- A p-value of 0.05 or less is often considered statistically significant $\Rightarrow$ statistically significantly different from 0
