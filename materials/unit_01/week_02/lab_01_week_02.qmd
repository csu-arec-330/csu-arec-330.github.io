...
carrot_seasonal <- na.omit(carrot_decomp$seasonal)[6:(length(carrot_ts)-7)] %>%
...
```
  ...
  > Did you get a warning? What does the warning message tell you? Because the decomposition 
